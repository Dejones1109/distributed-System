...
import com.hust.soict.de.helper.*;
 ...
 private static class Sorter extends Thread {
	 ...
	 public void run() {
		 try {
			 ...
			 //send a wellcome mesage to the client.
			 System.out.println("Hello,you are Client #"+ clientNumber);
			 //Get message from the client,line by line,Each line has several numbers separated by a space character
			 while(true) {
...
//				System.out.println(line);
			...
			try {
				...
				System.out.println("Connection with client #"+clientNumber + clientNumber + "closed");
			}
		}
	 }
